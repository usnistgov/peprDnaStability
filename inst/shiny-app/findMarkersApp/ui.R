...
## Tabbed layout
# shinyUI(navbarPage("Stability Gel Processing",
#                    tabPanel("Gel Lane Edges",
#                             fluidRow(
#                                 column(width = 2,
#                                        fileInput('gel_file',
#                                                  'Choose jpeg File',
...
#                                 column(width = 2,
#                                        numericInput('lanes',
#                                                     'Enter Number of Lanes in the Gel',
#                                                     value = 12, min = 1, max = 14, step = 1)),
#                                 column(width = 4,
#                                        checkboxGroupInput("ladder_lanes",
#                                                           "Select Lanes with Ladders",
#                                                           choices = list("Lane 1" = 1,
#                                                                          "Lane 2" = 2,
#                                                                          "Lane 3" = 3,
#                                                                          "Lane 4" = 4,
#                                                                          "Lane 5" = 5,
...
#                                        plotOutput('lanes'))#use offset = X to offset to left
#                             )),
#                    tabPanel("Set Marker ID Parameters",
#                             fluidRow(
#                                 column(width = 4,
#                                        sliderInput("bw_R1", "Bin Width Region 1",
#                                                    min = 1, max = 100, value = 5),
...
#                                                    min = 1, max = 10, value = 2)),
#                                 column(width = 4,
#                                        sliderInput("leftset", "Left Offset",
...
#                                        h6("Select same number of markers as number of peaks"),
#                                        checkboxGroupInput('markers', 'Marker Size in kb',
#                                                           choices = c(194,145.5,97,48.5,23.1,
#                                                                       9.42,6.55,4.36,2.32,2.03),
#                                                           selected = 194)))),
